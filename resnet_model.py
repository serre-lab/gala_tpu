...
def add_attention(inputs, attention, use_tpu, name, is_training):
  if attention == "se":
    ...
    inputs = LayerHelper(False, use_tpu, []).feature_attention_se(
        bottom=inputs,
        name=name,
        training=is_training)
  elif attention == "gala":
    # GALA attention
    inputs = LayerHelper(False, use_tpu, []).feature_attention_gala(
        bottom=inputs,
        name=name,
        training=is_training)
...
def block_group(
  ...
  """
  inputs = block_fn(  # First block uses projection shortcut and strides.
      inputs,
      filters,
      is_training,
      strides,
